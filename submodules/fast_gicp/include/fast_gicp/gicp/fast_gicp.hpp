...
public:
  ...
  virtual void setTargetCovariances(
	const std::vector<float>& input_rotationsq,
	const std::vector<float>& input_scales);
  virtual void setTargetControl(const std::vector<float>& target_control_score);
  ...
  virtual void setSourceIntensities(const std::vector<float>& input_intensities);
  ...
  const int getSourceIntensitiesSize() const {return source_intensities_.size();}
  ...
  const int getTargetControlSize() const {return target_control_score.size();}
  ...
  const std::vector<float>& getSourceIntensities() const {
    return source_intensities_;
  }
  ...
  const std::vector<float>& getTargetControl() const {return target_control_score;}
...
protected:
  ...
  std::vector<float> target_control_score;
...
//  std::vector<Eigen::Vector3d, Eigen::aligned_allocator<Eigen::Vector3d>> source_scales_;
  ...
  std::vector<float> source_intensities_;

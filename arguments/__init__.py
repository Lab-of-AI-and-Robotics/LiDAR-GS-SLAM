...
class SLAMParameters():
    def __init__(self):
        ...
        self.densify_until_iter = 15_000
        self.densify_grad_threshold = 0.0002 # 0.0002
        self.opt_lambda_normal = 0.05
        self.opt_lambda_alpha = 0.1
        self.opt_scaling_max = 0.05
        self.opt_scaling_max_penalty = 10.0
        self.opt_lambda_dist = 0.01
        self.decay_speed: 0.0125
        
        self.opt_lambda_isotropy = 0.05
        self.densify_threshold_egeom = 0.01
        ...
        self.keyframe_freq = 100 # replica : 10, tum : 10
        self.train = True
